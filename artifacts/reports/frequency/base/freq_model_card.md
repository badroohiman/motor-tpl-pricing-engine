...
## Run
- run_id: `freq_2026-03-04T13-59-21Z`
- created_at_utc: `2026-03-04T13:59:21+00:00`
...
- Link: **log**
- Formula:
  - `ClaimNb ~ VehPower + DrivAge + VehAge + BonusMalus + Density + C(Area) + C(VehBrand) + C(VehGas) + C(Region)`

## Evaluation (validation split)
- Zero rate (val): `0.9493963997846655`
- Obs annual rate (val): `0.10106632898668375`
- Pred annual rate mean (val): `0.10958567585648003`
- Exposure-weighted rate error (abs): `0.008519346869796288`
- MAE(count): `0.09971769060198796`
- RMSE(count): `0.23733795480671172`
- MAE(log1p(count)): `0.08061469728938025`
- RMSE(log1p(count)): `0.15967131315006644`
- AIC: `228503.78080794134`
- Deviance: `151359.20141066954`
- Scale: `1.0`
